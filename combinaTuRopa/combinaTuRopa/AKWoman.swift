...
class AKWoman: UIViewController,AKPickerViewDataSource, AKPickerViewDelegate{
    ...
    var camisas = [String]()
    var pants = [String]()
    let descCamisas = ["Sin seleccionar","Blusa tipo G color carmesí","Blusa tipo H color blaco","Sudadera con acabado color negro","Blusa tipo J color azul","Blusa tipo WI color verde","Blusa tipo RT color azul","Blusa tipo R color naranja","Sudadera con acabado tipo JS color blanco","Blusa con escote color negro"]
    let descPantalones = ["Sin seleccionar","Falda corta tipo J color carmesí","Jeans ASY color azul","Pants BYS color negro","Falda tipo CJ color rojo","Falda tipo CX color violeta","Falda tipo RA color verde","Falda YU color morado","Falda IPSO color rosa","Pants con acabado color blanco"]
    let descZapatos = ["Sin seleccionar","Tennis KIS color gris","Tennis HJK color aguamarina","Tennis RFT color negro","Tennis RMJ color rosa","Tennis JM color morado","Tenis MABD color blanco"]
